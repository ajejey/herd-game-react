/*
  ...
  engine treats all eleven the same way, so a hook that is subtly different is a
  hook that will be subtly broken on the one path nobody re-tests.

  See BUILDING_A_GAME.md for what each part of this is doing and why.
*/
