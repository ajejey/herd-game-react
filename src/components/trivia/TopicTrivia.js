  ...
  return (
    <MeadowLayout maxWidth="max-w-xl">
      ...
      <div className="bg-white/80 rounded-3xl border-4 border-[#FFE8C8] shadow-[0_18px_40px_-18px_rgba(45,24,16,0.25)] p-5 md:p-7">
        ...
        {!done && current && (
          <div>
            <p className="text-center text-sm font-semibold text-[#8B6347] uppercase tracking-wide">Question {idx + 1} of {quiz.length}</p>
          ...
          <div className="text-center">
            ...
            <div className="mt-4 max-w-sm mx-auto">
              ...
              <div className="mt-2 flex justify-center gap-2 flex-wrap">
                ...
                <Link to="/trivia" className="inline-flex items-center px-4 py-2.5 rounded-xl border-2 border-[#FFE8C8] text-[#2D1810] font-semibold text-base hover:border-[#E84A8B]">Daily Trivia →</Link>
              </div>
            </div>
      ...
      <div className="max-w-xl mx-auto mt-10 text-[#4A2D1B] leading-relaxed">
        ...
        <div className="mt-3">
          <Link to="/trivia-games" className="text-[#E84A8B] font-semibold underline text-base">See all trivia games →</Link>
        </div>
