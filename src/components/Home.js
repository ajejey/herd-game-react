        ...
        */}
        ...
        <section className="mb-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            ...
            >
              <div className="ribbon bg-[#4A90D9] text-white">✨ New</div>
              <div className="flex items-start gap-4">
                <div className="game-card-mascot shrink-0 text-5xl md:text-6xl select-none" aria-hidden="true">🎯</div>
                <div className="flex-1 min-w-0">
                  <h3 style={fredoka} className="text-2xl font-bold text-[#2D1810] leading-tight">
            ...
            <Link
              to="/taboo"
              className="game-card relative bg-white rounded-3xl border-4 border-[#D0463B] p-5 overflow-hidden block group"
            >
              <div className="ribbon bg-[#D0463B] text-white">✨ New</div>
              <div className="flex items-start gap-4">
                <div className="game-card-mascot shrink-0 text-5xl md:text-6xl select-none" aria-hidden="true">🚫</div>
                <div className="flex-1 min-w-0">
                  <h3 style={fredoka} className="text-2xl font-bold text-[#2D1810] leading-tight">
