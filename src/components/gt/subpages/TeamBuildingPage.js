...
export default function TeamBuildingPage() {
  return (
    ...
    >
      <p>
        <strong>Planning a virtual team-building event?</strong> Free browser-based trivia games are the easiest way to bring remote and hybrid teams together — no IT approval for downloads, no per-seat licensing, no setup friction. <a href="/guesstimate">Guesstimate</a> is a free trivia-betting game purpose-built for adult party play, which makes it a solid fit for office trivia, virtual happy hours, and team-building events.
      </p>

      <h2>Why trivia works for team building</h2>
      <ul>
        <li><strong>Levels rank.</strong> A junior employee can outscore a VP. Knowledge is distributed unpredictably across a team.</li>
        <li><strong>Creates banter.</strong> Trivia answers (especially wrong ones) become inside jokes that last weeks.</li>
        <li><strong>Low cognitive load.</strong> Unlike puzzle-based team-building, trivia doesn't require deep strategic thinking — people can engage casually.</li>
        <li><strong>Time-bounded.</strong> 25 minutes is a natural slot. People can be back at their desks for the next meeting.</li>
        <li><strong>Inclusive.</strong> Quiet team members can compete just as effectively as the loud ones.</li>
      </ul>

      <h2>Why Guesstimate is well-suited for office events</h2>
      <ul>
        <li><strong>Free.</strong> No per-seat licensing, no procurement, no expense report.</li>
        <li><strong>No download.</strong> Runs in browser — no IT approval needed for Mac, PC, or BYOD phones.</li>
        <li><strong>No signup.</strong> No data collection on employees. No "log in with your work email" friction.</li>
        <li><strong>2–12 players.</strong> Fits most team sizes. Larger groups can run parallel rooms in breakouts.</li>
        <li><strong>25 minutes.</strong> Fits one calendar slot without overrunning.</li>
        <li><strong>Family-safe content.</strong> No HR risk. All questions are factual, educational.</li>
        <li><strong>Betting mechanic creates banter.</strong> The strategic depth means people talk about choices, not just answers.</li>
        <li><strong>Works hybrid.</strong> Everyone uses their own device, regardless of in-office or remote.</li>
      </ul>
      ...
      <h3>1. Pick a time</h3>
      <p>
        Avoid Mondays (back-to-work overwhelm) and Friday afternoons (mental checkout). Best slots: mid-week, late morning (10–11 AM) or end-of-day (4–5 PM). For global teams, find an overlap window.
      </p>
      ...
      <p>
        Quick "here's how to play" — write a number, bet 2 chips, closest without going over wins. Don't over-explain; people learn by playing.
      </p>

      <h3>5. Play one game (~25 min)</h3>
      <p>
        7 rounds, 3–4 minutes each. The host can use "Skip slow players" if someone is afk.
      </p>

      <h3>6. Wrap with 5 min of banter</h3>
      <p>
        Final scoreboard becomes the conversation starter. "Wait, how did Sarah know that one?" is the team-bonding moment.
      </p>

      <h3>7. End on time</h3>
      <p>
        Don't go past 45 minutes total. Leave them wanting more.
      </p>
      ...
      <ul>
        <li><strong>2 parallel rooms of 6–10.</strong> Use Zoom breakout rooms. Each room runs its own game. Compare scoreboards at the end.</li>
        <li><strong>Tournament format.</strong> 4 rooms × 6 players = 24 people in the qualifier. Top 2 from each room → final round of 8.</li>
        <li><strong>Pair vs. pair format.</strong> Pair up teammates (rotating each round). Pairs share a single login. Promotes cross-team conversation.</li>
      </ul>
      ...
      <p>
        After the formal all-hands, optional 30-min game room for anyone who wants to stick around. No mandatory attendance — opt-in.
      </p>
      ...
      <p>
        Mix people who don't normally work together. Trivia gives everyone a shared activity that doesn't require domain expertise.
      </p>
      ...
      <p>
        Even at in-person retreats, browser-based trivia works because everyone has a phone. Beats prepared icebreaker games.
      </p>

      <h2>Common mistakes to avoid</h2>
      <ul>
        <li><strong>Making it mandatory.</strong> Voluntary attendance gets the people who actually want to be there.</li>
        <li><strong>Forcing cameras on.</strong> Optional is better. Some people just don't want to be on camera.</li>
        <li><strong>Going over time.</strong> 45 minutes max. Calendar fatigue kills team-building energy.</li>
        <li><strong>Picking a game that needs downloads.</strong> Loses 30% of participants to "install issues".</li>
      ...
      <ul>
        ...
        <li><strong>Kahoot</strong> — large-group multiple-choice trivia. Better for 20+ players where you want everyone simultaneously. Less party-game-feel than Guesstimate.</li>
        <li><strong>Custom Google Form trivia</strong> — for company-specific questions. High setup, high payoff for milestone events.</li>
        <li><strong>Paid SaaS team-building (Confetti, Outback, Goosechase)</strong> — full-service if you want a facilitator. $$$.</li>
      </ul>
    </SubPageLayout>
  );
}
