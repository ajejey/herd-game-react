...
const FAQS = [
  ...
  { q: 'What games can you play over a video call with no app or download?', a: 'Anything browser-based works without an install. Open herdgamesonline.com/guesstimate, create a room, and share the code — everyone joins from their own phone or laptop while on Zoom, FaceTime, Google Meet, or Discord. Classic verbal games like 20 Questions and Never Have I Ever also need nothing but the call itself.' },
