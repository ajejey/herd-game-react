  ...
  return (
    <div className="max-w-lg mx-auto">
      <div className="bg-white rounded-2xl border-2 border-[#FFE8C8] p-4 mb-4 text-center">
        <p className="text-sm uppercase tracking-widest text-[#8B6347] mb-1">The question</p>
      ...
      {!allTokensPlaced && (
        <p className="text-center text-base font-bold text-[#E84A8B] mb-2 flex items-center justify-center gap-1.5 animate-[gtArrow_1.2s_ease-in-out_infinite]">
      ...
      {allTokensPlaced && (
        <div className="mt-2 px-4 py-3 bg-[#F0FFF4] border-2 border-[#3D8B5A] rounded-xl flex items-center justify-center gap-2 mb-4">
          <ClockIcon size={20} />
          <p className="text-[#2F6E45] font-semibold text-base">Chips locked in — waiting for others…</p>
        </div>
      )}
      ...
      {isHost && (
        <div className="flex justify-center gap-2 flex-wrap">
          ...
          <button
            ...
            className="px-4 py-2 rounded-lg border-2 border-red-300 text-red-500 text-sm font-semibold hover:bg-red-50"
          >
            Cancel round
          </button>
        </div>
