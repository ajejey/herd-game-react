...
export default function HowToPlay({ onClose, compact = false }) {
  ...
  return (
    <Wrap>
      ...
      <p className="text-[#8B6347] text-base mb-4">A trivia-betting party game. Quick read — you'll get it in one round.</p>
      ...
      <ol className="space-y-3 text-[#2D1810] text-base mb-5">
        <li className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-[#8B6347] text-sm">Every question has a numerical answer. E.g. "How many bones in the human body?"</p>
          </div>
        </li>
        <li className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-[#8B6347] text-sm">No partial credit. Just one number.</p>
          </div>
        </li>
        <li className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-[#8B6347] text-sm">Sorted low → high. The lowest guess has the longest odds (5×), highest has the shortest (1×).</p>
          </div>
        </li>
        <li className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-[#8B6347] text-sm">Own or others. Double down (both on one) or hedge (split across two).</p>
          </div>
        </li>
        <li className="flex gap-3">
          ...
          <div>
            ...
            <p className="text-[#8B6347] text-sm">Closest WITHOUT going over wins. If all guesses are over, the lowest one wins.</p>
          </div>
        </li>
      </ol>
      ...
      <p className="text-center text-[#8B6347] text-sm italic">7 rounds. Highest score wins 🏆</p>
    </Wrap>
  );
}
