  ...
  return (
    <MeadowLayout maxWidth="max-w-2xl">
      ...
      <div className="max-w-2xl mx-auto mt-10 text-[#4A2D1B] leading-relaxed">
        ...
        <p className="mb-4">
          No board, no cards, no app — just open it in any browser, share a 4-letter room code, and play with 3 to 6 friends on their own devices. It works great over a <Link to="/guesstimate/games-to-play-on-facetime-and-video-calls" className="text-[#E84A8B] font-semibold underline">video call</Link>. It's the easiest way to <Link to="/clover/play-so-clover-online-free" className="text-[#E84A8B] font-semibold underline">play So Clover online free</Link>, one of the best <Link to="/clover/cooperative-word-games-online" className="text-[#E84A8B] font-semibold underline">cooperative word games</Link> for groups, and a natural <Link to="/clover/virtual-team-building-word-games" className="text-[#E84A8B] font-semibold underline">virtual team-building</Link> pick or <Link to="/clover/word-games-for-family-game-night" className="text-[#E84A8B] font-semibold underline">family game night</Link> game. Clue-game fan? See <Link to="/clover/games-like-codenames-online" className="text-[#E84A8B] font-semibold underline">games like Codenames</Link>. Looking for more? Try <Link to="/caveman-clues" className="text-[#E84A8B] font-semibold underline">Caveman Clues</Link>, <Link to="/hue-match" className="text-[#E84A8B] font-semibold underline">Hue Match</Link>, <Link to="/guesstimate" className="text-[#E84A8B] font-semibold underline">Guesstimate</Link>, <Link to="/say-anything" className="text-[#E84A8B] font-semibold underline">Say Anything</Link>, or the solo <Link to="/daily" className="text-[#E84A8B] font-semibold underline">Daily Herd</Link>.
        </p>
