  ...
  if (mine.submitted) {
    return (
      <div className="max-w-md mx-auto text-center">
        ...
        <ul className="mt-4 inline-flex flex-col gap-1 text-base">
          {players.map((p) => (
        ...
        {isHost && submittedCount < players.length && (
          <div className="mt-5">
            <button onClick={() => sendAction('force_resolve')}
              className="text-base underline text-[#3D8B5A] font-semibold">
  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <div className="space-y-3 mt-4">
        {pairs.map(([a, b], i) => (
          <div key={i}>
            <label className="text-base font-semibold text-[#2D1810]">
      ...
      <p className="text-sm text-[#8B6347] mt-2 text-center">One word each. Can't be one of your own words.</p>
