  ...
  return (
    <div className="max-w-md mx-auto">
      ...
      <div className="bg-[#FFF6E9] rounded-2xl border-2 border-[#FFE8C8] p-4 mb-4">
        <h3 style={fredokaStyle} className="text-base font-bold text-[#2D1810] mb-2">How Clover Clues works</h3>
      ...
      {isHost ? (
        <div className="space-y-2">
          {connected.length < 3 ? (
            ...
            <p className="text-center text-[#8B6347] text-base">{connected.length} players in — start when everyone's ready.</p>
          )}
