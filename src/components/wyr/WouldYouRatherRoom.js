  ...
  if (state.status === 'lobby') {
    return (
      <MeadowLayout maxWidth="max-w-lg">
        <div className="bg-white rounded-3xl border-4 border-[#FFE8C8] p-6 text-center">
          <h1 style={fredokaStyle} className="text-3xl font-bold text-[#2D1810] mb-4">Would You Rather 🤔</h1>

          <LobbyInvite gamePath="would-you-rather" roomCode={code} gameName="Would You Rather"
