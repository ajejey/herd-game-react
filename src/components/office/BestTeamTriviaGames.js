  ...
  return (
    <MeadowLayout maxWidth="max-w-2xl">
      ...
      <div className="max-w-2xl mx-auto text-[#4A2D1B] leading-relaxed">
        ...
        <p className="mb-3">
          Trivia isn't the only option. For a change of pace, your team can also play <Link to="/say-anything" className="text-[#E84A8B] underline">Say Anything</Link> (write the funniest answer), <Link to="/spectrum" className="text-[#E84A8B] underline">Spectrum</Link> (a Wavelength-style guessing game), <Link to="/scattergories" className="text-[#E84A8B] underline">Scattergories</Link> (fast word game), <Link to="/caveman-clues" className="text-[#E84A8B] underline">Caveman Clues</Link>, <Link to="/taboo" className="text-[#E84A8B] underline">Taboo</Link> (describe it without the forbidden words), <Link to="/chameleon" className="text-[#E84A8B] underline">Chameleon</Link> (social deduction), or <Link to="/guesstimate" className="text-[#E84A8B] underline">Guesstimate</Link> — all free, all in the browser. See the full <Link to="/office-games" className="text-[#E84A8B] underline">office games</Link> list, or the specifics for <Link to="/office-games/games-to-play-on-microsoft-teams" className="text-[#E84A8B] underline">games to play on Microsoft Teams</Link>.
        </p>
