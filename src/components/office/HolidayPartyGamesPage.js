  ...
  return (
    ...
    >
      ...
      <ol>
        ...
        <li><strong>30–45 min: something loud.</strong> <Link to="/caveman-clues">Caveman Clues</Link>, <Link to="/hue-match">Hue Match</Link>, <Link to="/taboo">Taboo</Link> or <Link to="/scattergories">Scattergories</Link> to lift the energy after a quieter quiz.</li>
